...
public class SharedBudgetCategoryListAdapter extends BaseAdapter
{
    ArrayList<BudgetCategory> budgetCategories;
    Context context;

    public SharedBudgetCategoryListAdapter(Context context, ArrayList<BudgetCategory> budgetCategories) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent = new Intent( context , SharedListingCategoryTransaction.class);
