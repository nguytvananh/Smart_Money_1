...
public class SharedWalletCategoryListAdapter extends BaseAdapter
{
    ArrayList<BudgetCategory> budgetCategories;
    Context context;

    public SharedWalletCategoryListAdapter(Context context, ArrayList<BudgetCategory> budgetCategories) {
