package com.nhom10.smartmoney1.sharedWalletManagement.sharedBudgetplanner.activities;
...
import com.nhom10.smartmoney1.budgetplanner.ui.BudgetPlannerFragment;
...
import com.nhom10.smartmoney1.sharedWalletManagement.sharedBudgetplanner.ui.SharedBudgetPlannerFragment;
...
public class SharedPlanInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (editPlan) {
                ...
                oldSharedPlan = new SharedPlan(planID , title, desc, budget, date);
            }
        }catch (Exception e)
        {
            e.printStackTrace();
    ...
    public void onClickAddPlan(View view)
    {
        ...
        if(editPlan)
        {
            SharedPlansManager.editPlan(oldSharedPlan.getPlanID() , title, desc, budget, deadline);
